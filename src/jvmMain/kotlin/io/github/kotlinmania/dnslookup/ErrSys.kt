// port-lint: ignore — actual for the commonMain `ErrSys` expect-object; the JDK performs name resolution itself and does not surface libc gai codes, so values follow Linux glibc EAI conventions.
...
internal actual object ErrSys {
    ...
    actual fun gaiStrError(err: Int): String =
        when (err) {
