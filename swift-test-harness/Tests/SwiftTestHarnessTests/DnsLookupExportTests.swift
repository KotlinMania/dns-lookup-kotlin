...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `DnsLookup.swiftmodule/`
...
//      `import DnsLookup` above would fail at compile time.
//
//   2. The static archive `libDnsLookup.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "DnsLookup" }` and
//      `flattenPackage = "io.github.kotlinmania.dnslookup"` configuration in
...
//      via the `DnsLookupLibrary` product.
//
