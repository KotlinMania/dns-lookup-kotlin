...
This file is the quick-reference operating contract for dns-lookup-kotlin. The longer
...
dns-lookup-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`dns-lookup`](https://crates.io/crates/dns-lookup). Upstream Rust is the behavioral oracle while the
