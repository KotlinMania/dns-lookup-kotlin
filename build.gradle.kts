...
kotlin {
    ...
    val xcf = XCFramework("DnsLookup")

    macosArm64 {
        binaries.framework { baseName = "DnsLookup"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework {
            baseName = "DnsLookup"
    ...
    swiftExport {
        ...
        flattenPackage = "io.github.kotlinmania.dnslookup"
    }

    android {
        namespace = "io.github.kotlinmania.dnslookup"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "dns-lookup-kotlin", version.toString())

    pom {
        name.set("dns-lookup-kotlin")
        description.set("Kotlin Multiplatform port of keeperofdakeys/dns-lookup - A simple dns resolving api, much like rust's unstable api. Also includes getaddrinfo and getnameinfo wrappers for libc variants")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/dns-lookup-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/dns-lookup-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/dns-lookup-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/dns-lookup-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.dnslookup.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "embedSwiftExportForXcode",
    "assembleDnsLookupXCFramework",
    "assembleDnsLookupDebugXCFramework",
    "assembleDnsLookupReleaseXCFramework",
    "assembleDebugIosFatFrameworkForDnsLookupXCFramework",
    "assembleReleaseIosFatFrameworkForDnsLookupXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForDnsLookupXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForDnsLookupXCFramework",
    "assembleDebugMacosFatFrameworkForDnsLookupXCFramework",
    "assembleReleaseMacosFatFrameworkForDnsLookupXCFramework",
    "assembleDebugTvosFatFrameworkForDnsLookupXCFramework",
    "assembleReleaseTvosFatFrameworkForDnsLookupXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForDnsLookupXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForDnsLookupXCFramework",
    "assembleDebugWatchosFatFrameworkForDnsLookupXCFramework",
    "assembleReleaseWatchosFatFrameworkForDnsLookupXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForDnsLookupXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForDnsLookupXCFramework",
